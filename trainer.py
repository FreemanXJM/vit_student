...
class Trainer(object):
    ...
    def __init__(self, config, data_loader):
        ...
        for i in range(self.model_num):
            ...
            # model.head = nn.Linear(num_ftrs, 100, bias=True)
            ...
            optimizer = optim.Lamb(model.parameters(), lr=self.lr, weight_decay=self.weight_decay)

            self.optimizers.append(optimizer)

            # set learning rate decay
            scheduler = CosineLRScheduler(optimizer=optimizer, t_initial=5)
