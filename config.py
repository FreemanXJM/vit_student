...
data_arg.add_argument('--pin_memory', type=str2bool, default=True,
                      help='whether to copy tensors into CUDA pinned memory')  # 是否锁页，这样将内存的Tensor转义到GPU的显存就会更快一些。
...
train_arg.add_argument('--momentum', type=float, default=0.9,
                       help='Momentum value') # 为解决SGD中出现的曲折摆动问题
train_arg.add_argument('--epochs', type=int, default=900,
                       help='# of epochs to train for')
train_arg.add_argument('--init_lr', type=float, default=1.3e-3,
                       help='Initial learning rate value')
train_arg.add_argument('--weight_decay', type=float, default=0.02,
                       help='value of weight decay for regularization')
...
train_arg.add_argument('--gamma', type=float, default=0.02,
